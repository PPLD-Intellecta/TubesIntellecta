...
<head>
    ...
    <title>Tambah Video Baru - Intellecta Admin</title>
...
<body class="bg-gray-50 font-sans antialiased">
    <div class="min-h-screen flex">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Video Baru</h1>
                <p class="text-sm text-gray-500 mt-1">Buat materi video pembelajaran baru untuk diakses oleh siswa.</p>
            </div>
                ...
                <div class="p-6 sm:p-8">
                    <form action="{{ route('admin.videos.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="url_video" id="url_video" required value="{{ old('url_video') }}"
